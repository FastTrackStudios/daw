...
/// `animation_toolbar_armed.png` — 30x360, 2263 rects.
...
/// `animation_toolbar_highlight.png` — 30x360, 6500 rects.
...
/// `custom_comping.png` — 60x15, 108 rects.
...
/// `custom_envcp_arm_bg.png` — 22x22, 48 rects.
...
/// `custom_fixed_lanes_off.png` — 60x24, 102 rects.
...
/// `custom_fixed_lanes_on.png` — 60x24, 102 rects.
...
/// `custom_master_track_pin_off.png` — 57x19, 142 rects.
...
/// `custom_master_track_pin_on.png` — 57x19, 143 rects.
...
/// `custom_mcp_folder_1-1.png` — 16x21, 48 rects.
...
/// `custom_mcp_folder_1-2.png` — 16x21, 43 rects.
...
/// `custom_mcp_folder_1-4.png` — 16x21, 33 rects.
...
/// `custom_mcp_folder_1-8.png` — 16x21, 24 rects.
...
/// `custom_mcp_folder_start.png` — 11x20, 24 rects.
...
/// `custom_mcp_sel_gradient.png` — 3x42, 27 rects.
...
/// `custom_tcp_namebg.png` — 24x24, 43 rects.
...
/// `custom_track_divider.png` — 1x1, 0 rects.
...
/// `custom_track_folder_1-1.png` — 18x14, 43 rects.
...
/// `custom_track_folder_1-2.png` — 18x14, 31 rects.
...
/// `custom_track_folder_1-4.png` — 18x14, 23 rects.
...
/// `custom_track_folder_1-8.png` — 18x14, 19 rects.
...
/// `custom_track_folder_half_1-1.png` — 18x14, 29 rects.
...
/// `custom_track_folder_half_1-2.png` — 18x14, 21 rects.
...
/// `custom_track_folder_half_1-4.png` — 18x14, 17 rects.
...
/// `custom_track_folder_half_1-8.png` — 18x14, 13 rects.
...
/// `custom_track_folder_recarm.png` — 20x20, 48 rects.
...
/// `custom_track_io_darker.png` — 30x22, 99 rects.
...
/// `custom_track_io_text_off.png` — 32x22, 46 rects.
...
/// `custom_track_io_text_on.png` — 32x22, 46 rects.
...
/// `custom_track_pin_off.png` — 57x19, 142 rects.
...
/// `custom_track_pin_on.png` — 57x19, 188 rects.
...
/// `custom_track_recarm_bg.png` — 24x24, 50 rects.
...
/// `custom_transport_edit_bg.png` — 32x32, 77 rects.
...
/// `custom_transport_edit_div.png` — 1x1, 1 rects.
...
/// `custom_transport_sel_end.png` — 6x6, 11 rects.
...
/// `custom_transport_sel_start.png` — 6x6, 11 rects.
...
/// `envcp_arm_off.png` — 60x20, 416 rects.
...
/// `envcp_arm_on.png` — 60x20, 663 rects.
...
/// `envcp_bypass_off.png` — 45x20, 189 rects.
...
/// `envcp_bypass_on.png` — 45x20, 189 rects.
...
/// `envcp_fader.png` — 23x29, 108 rects.
...
/// `envcp_faderbg.png` — 19x24, 19 rects.
...
/// `envcp_hide.png` — 108x20, 531 rects.
...
/// `envcp_knob_small.png` — 25x26, 188 rects.
...
/// `envcp_learn.png` — 90x20, 422 rects.
...
/// `envcp_learn_on.png` — 90x20, 453 rects.
...
/// `envcp_namebg.png` — 22x24, 1 rects.
...
/// `envcp_parammod.png` — 90x20, 480 rects.
...
/// `envcp_parammod_on.png` — 90x20, 510 rects.
...
/// `fixed_lanes_big.png` — 60x20, 210 rects.
...
/// `fixed_lanes_hidden.png` — 60x20, 27 rects.
...
/// `fixed_lanes_one.png` — 60x20, 198 rects.
...
/// `fixed_lanes_small.png` — 60x20, 221 rects.
...
/// `gen_back_on.png` — 60x20, 261 rects.
...
/// `gen_env_latch.png` — 60x20, 926 rects.
...
/// `gen_env_preview.png` — 60x20, 940 rects.
...
/// `gen_env_read.png` — 60x20, 929 rects.
...
/// `gen_env_touch.png` — 60x20, 947 rects.
...
/// `gen_env_write.png` — 60x20, 927 rects.
...
/// `gen_forward.png` — 60x20, 261 rects.
...
/// `gen_forward_on.png` — 60x20, 261 rects.
...
/// `gen_knob_bg_small.png` — 18x20, 87 rects.
...
/// `gen_midi_off.png` — 60x20, 408 rects.
...
/// `gen_midi_on.png` — 60x20, 879 rects.
...
/// `gen_mute_off.png` — 60x20, 337 rects.
...
/// `gen_mute_on.png` — 60x20, 601 rects.
...
/// `gen_panbg_horz.png` — 24x22, 35 rects.
...
/// `gen_panbg_horz_dark.png` — 24x22, 35 rects.
...
/// `gen_panthumb_horz.png` — 19x29, 110 rects.
...
/// `gen_pause_on.png` — 72x24, 157 rects.
...
/// `gen_phase_inv.png` — 60x20, 501 rects.
...
/// `gen_phase_norm.png` — 60x20, 429 rects.
...
/// `gen_play_on.png` — 72x24, 1149 rects.
...
/// `gen_refresh.png` — 60x20, 383 rects.
...
/// `gen_repeat_off.png` — 72x24, 501 rects.
...
/// `gen_repeat_on.png` — 72x24, 747 rects.
...
/// `gen_solo_off.png` — 60x20, 360 rects.
...
/// `gen_solo_on.png` — 60x19, 377 rects.
...
/// `gen_stereo.png` — 60x20, 519 rects.
...
/// `gen_volbg_horz.png` — 24x22, 35 rects.
...
/// `gen_volbg_horz_dark.png` — 24x22, 35 rects.
...
/// `gen_volbg_vert.png` — 22x24, 35 rects.
...
/// `gen_volbg_vert_dark.png` — 22x24, 35 rects.
...
/// `gen_volthumb_horz.png` — 25x29, 110 rects.
...
/// `gen_volthumb_vert.png` — 21x31, 201 rects.
...
/// `global_bypass.png` — 180x26, 934 rects.
...
/// `global_latch.png` — 180x26, 1028 rects.
...
/// `global_off.png` — 180x26, 701 rects.
...
/// `global_preview.png` — 180x26, 978 rects.
...
/// `global_read.png` — 180x26, 975 rects.
...
/// `global_touch.png` — 180x26, 1065 rects.
...
/// `global_trim.png` — 180x26, 948 rects.
...
/// `global_write.png` — 180x26, 1043 rects.
...
/// `item_env_off.png` — 42x14, 117 rects.
...
/// `item_env_off_hidpi.png` — 84x28, 270 rects.
...
/// `item_env_on.png` — 42x14, 144 rects.
...
/// `item_env_on_hidpi.png` — 84x28, 282 rects.
...
/// `item_fx_off.png` — 42x14, 181 rects.
...
/// `item_fx_off_hidpi.png` — 84x28, 448 rects.
...
/// `item_fx_on.png` — 42x14, 206 rects.
...
/// `item_fx_on_hidpi.png` — 84x28, 450 rects.
...
/// `item_group.png` — 42x14, 187 rects.
...
/// `item_group_hidpi.png` — 84x28, 424 rects.
...
/// `item_group_sel.png` — 42x14, 213 rects.
...
/// `item_group_sel_hidpi.png` — 84x28, 428 rects.
...
/// `item_lock_off.png` — 42x14, 117 rects.
...
/// `item_lock_off_hidpi.png` — 84x28, 231 rects.
...
/// `item_lock_on.png` — 42x14, 141 rects.
...
/// `item_lock_on_hidpi.png` — 84x28, 231 rects.
...
/// `item_mute_off.png` — 42x14, 193 rects.
...
/// `item_mute_off_hidpi.png` — 84x28, 462 rects.
...
/// `item_mute_on.png` — 42x14, 387 rects.
...
/// `item_mute_on_hidpi.png` — 84x28, 1068 rects.
...
/// `item_note_off.png` — 42x14, 162 rects.
...
/// `item_note_off_hidpi.png` — 84x28, 388 rects.
...
/// `item_note_on.png` — 42x14, 189 rects.
...
/// `item_note_on_hidpi.png` — 84x28, 390 rects.
...
/// `item_pooled.png` — 42x14, 60 rects.
...
/// `item_pooled_hidpi.png` — 84x28, 114 rects.
...
/// `item_pooled_on.png` — 42x14, 84 rects.
...
/// `item_pooled_on_hidpi.png` — 84x28, 114 rects.
...
/// `item_props_hidpi.png` — 84x28, 183 rects.
...
/// `item_props_on.png` — 42x14, 69 rects.
...
/// `item_props_on_hidpi.png` — 84x28, 183 rects.
...
/// `item_rank_down.png` — 42x14, 354 rects.
...
/// `item_rank_down_hidpi.png` — 84x28, 846 rects.
...
/// `item_rank_hidpi.png` — 84x28, 744 rects.
...
/// `item_rank_up.png` — 42x14, 259 rects.
...
/// `item_rank_up_hidpi.png` — 84x28, 645 rects.
...
/// `item_timebase_beat.png` — 42x14, 210 rects.
...
/// `item_timebase_beat_hidpi.png` — 84x28, 516 rects.
...
/// `item_timebase_beat_on.png` — 42x14, 232 rects.
...
/// `item_timebase_beat_on_hidpi.png` — 84x28, 516 rects.
...
/// `item_timebase_time.png` — 42x14, 220 rects.
...
/// `item_timebase_time_hidpi.png` — 84x28, 556 rects.
...
/// `item_timebase_time_on.png` — 42x14, 244 rects.
...
/// `item_timebase_time_on_hidpi.png` — 84x28, 564 rects.
...
/// `item_volknob.png` — 48x18, 271 rects.
...
/// `item_volknob_hidpi.png` — 84x28, 673 rects.
...
/// `lane_solo_down.png` — 60x15, 72 rects.
...
/// `lane_solo_off.png` — 57x24, 465 rects.
...
/// `lane_solo_off_indicator.png` — 24x8, 146 rects.
...
/// `lane_solo_on.png` — 57x24, 345 rects.
...
/// `lane_solo_on_indicator.png` — 24x8, 110 rects.
...
/// `lane_solo_up.png` — 60x15, 66 rects.
...
/// `mcp_env_latch.png` — 65x32, 356 rects.
...
/// `mcp_env_preview.png` — 65x32, 342 rects.
...
/// `mcp_env_read.png` — 65x32, 363 rects.
...
/// `mcp_env_touch.png` — 65x32, 267 rects.
...
/// `mcp_env_write.png` — 65x32, 381 rects.
...
/// `mcp_extmixbgsel.png` — 3x3, 1 rects.
...
/// `mcp_fcomp_off.png` — 149x23, 95 rects.
...
/// `mcp_fcomp_tiny.png` — 149x23, 111 rects.
...
/// `mcp_folder_last.png` — 63x21, 69 rects.
...
/// `mcp_folder_on.png` — 55x15, 2 rects.
...
/// `mcp_fx_dis.png` — 86x22, 372 rects.
...
/// `mcp_fx_empty.png` — 86x22, 378 rects.
...
/// `mcp_fx_in_empty.png` — 225x12, 421 rects.
...
/// `mcp_fx_in_empty_ol_2.png` — 225x12, 421 rects.
...
/// `mcp_fx_in_norm.png` — 225x12, 435 rects.
...
/// `mcp_fx_in_norm_ol_2.png` — 225x12, 435 rects.
...
/// `mcp_fx_norm.png` — 86x22, 381 rects.
...
/// `mcp_fxlist_bg.png` — 44x6, 1 rects.
...
/// `mcp_fxlist_byp.png` — 38x53, 115 rects.
...
/// `mcp_fxlist_empty.png` — 38x53, 75 rects.
...
/// `mcp_fxlist_norm.png` — 38x53, 185 rects.
...
/// `mcp_fxlist_off.png` — 38x53, 115 rects.
...
/// `mcp_fxparm_bg.png` — 44x6, 1 rects.
...
/// `mcp_fxparm_byp.png` — 38x50, 230 rects.
...
/// `mcp_fxparm_empty.png` — 38x50, 123 rects.
...
/// `mcp_fxparm_knob_stack.png` — 23x1150, 5036 rects.
...
/// `mcp_fxparm_norm.png` — 38x50, 213 rects.
...
/// `mcp_fxparm_off.png` — 38x50, 215 rects.
...
/// `mcp_iconbgsel.png` — 6x11, 6 rects.
...
/// `mcp_io_dis.png` — 71x32, 513 rects.
...
/// `mcp_io_r_dis.png` — 71x32, 552 rects.
...
/// `mcp_io_s_dis.png` — 71x32, 554 rects.
...
/// `mcp_io_s_r.png` — 71x32, 618 rects.
...
/// `mcp_io_s_r_dis.png` — 71x32, 581 rects.
...
/// `mcp_main_namebg.png` — 8x9, 8 rects.
...
/// `mcp_main_namebg_sel.png` — 8x9, 8 rects.
...
/// `mcp_mainextmixbg.png` — 9x8, 1 rects.
...
/// `mcp_mainextmixbgsel.png` — 9x8, 2 rects.
...
/// `mcp_master_vol_label.png` — 43x5, 1 rects.
...
/// `mcp_master_volbg.png` — 129x52, 13 rects.
...
/// `mcp_master_volthumb.png` — 27x53, 434 rects.
...
/// `mcp_monitor_auto.png` — 63x20, 633 rects.
...
/// `mcp_monitor_off.png` — 63x20, 840 rects.
...
/// `mcp_monitor_on.png` — 63x20, 682 rects.
...
/// `mcp_mute_off.png` — 63x20, 357 rects.
...
/// `mcp_mute_on.png` — 63x20, 714 rects.
...
/// `mcp_pan_knob_large.png` — 28x29, 306 rects.
...
/// `mcp_pan_knob_small.png` — 24x25, 246 rects.
...
/// `mcp_panthumb.png` — 13x23, 81 rects.
...
/// `mcp_phase_inv.png` — 48x18, 518 rects.
...
/// `mcp_phase_norm.png` — 48x18, 495 rects.
...
/// `mcp_recarm_auto.png` — 108x24, 595 rects.
...
/// `mcp_recarm_auto_norec.png` — 108x24, 627 rects.
...
/// `mcp_recarm_auto_on.png` — 108x24, 627 rects.
...
/// `mcp_recarm_norec.png` — 108x24, 701 rects.
...
/// `mcp_recarm_off.png` — 108x24, 560 rects.
...
/// `mcp_recarm_on.png` — 108x24, 564 rects.
...
/// `mcp_recinput.png` — 25x18, 64 rects.
...
/// `mcp_recmode_in.png` — 125x18, 330 rects.
...
/// `mcp_recmode_off.png` — 125x18, 577 rects.
...
/// `mcp_recmode_out.png` — 125x18, 467 rects.
...
/// `mcp_send_knob_stack.png` — 23x1150, 5036 rects.
...
/// `mcp_sendlist_bg.png` — 44x6, 1 rects.
...
/// `mcp_sendlist_empty.png` — 38x50, 125 rects.
...
/// `mcp_sendlist_meter.png` — 38x26, 25 rects.
...
/// `mcp_sendlist_midihw.png` — 38x50, 219 rects.
...
/// `mcp_sendlist_mute.png` — 38x50, 219 rects.
...
/// `mcp_sendlist_norm.png` — 38x50, 210 rects.
...
/// `mcp_solo_off.png` — 63x20, 413 rects.
...
/// `mcp_solo_on.png` — 63x20, 489 rects.
...
/// `mcp_solodefeat_on.png` — 63x20, 513 rects.
...
/// `mcp_stereo.png` — 77x35, 863 rects.
...
/// `mcp_volbg_horz.png` — 4x4, 0 rects.
...
/// `mcp_volthumb.png` — 27x53, 434 rects.
...
/// `mcp_width_knob_large.png` — 28x29, 306 rects.
...
/// `mcp_width_knob_small.png` — 24x25, 246 rects.
...
/// `mcp_widthbg.png` — 69x11, 33 rects.
...
/// `mcp_widththumb.png` — 13x23, 81 rects.
...
/// `meter_automute.png` — 20x20, 309 rects.
...
/// `meter_clip_v_rms2.png` — 4x4, 2 rects.
...
/// `meter_foldermute.png` — 12x12, 16 rects.
...
/// `meter_solodim.png` — 12x12, 11 rects.
...
/// `meter_strip_h.png` — 168x16, 142 rects.
...
/// `meter_strip_h_rms.png` — 2x32, 8 rects.
...
/// `meter_strip_v.png` — 32x168, 238 rects.
...
/// `meter_strip_v_rms.png` — 32x2, 8 rects.
...
/// `meter_unsolo.png` — 12x12, 18 rects.
...
/// `midi_inline_ccwithitems_off.png` — 42x14, 120 rects.
...
/// `midi_inline_ccwithitems_on.png` — 42x14, 120 rects.
...
/// `midi_inline_close.png` — 42x14, 183 rects.
...
/// `midi_inline_fold_custom_view.png` — 42x14, 135 rects.
...
/// `midi_inline_fold_none.png` — 42x14, 114 rects.
...
/// `midi_inline_fold_unnamed.png` — 42x14, 123 rects.
...
/// `midi_inline_fold_unused_unnamed.png` — 42x14, 132 rects.
...
/// `midi_inline_noteview_diamond.png` — 42x14, 105 rects.
...
/// `midi_inline_noteview_rect.png` — 42x14, 27 rects.
...
/// `midi_inline_noteview_triangle.png` — 42x14, 51 rects.
...
/// `midi_inline_scroll.png` — 42x14, 135 rects.
...
/// `midi_inline_scrollbar.png` — 12x19, 1 rects.
...
/// `midi_inline_scrollthumb.png` — 45x16, 0 rects.
...
/// `midi_item_bounds.png` — 25x10, 88 rects.
...
/// `midi_note_colormap.png` — 157x130, 16814 rects.
...
/// `midi_score_colormap.png` — 157x130, 471 rects.
...
/// `mixer_menu.png` — 60x20, 314 rects.
...
/// `monitor_fx_byp.png` — 156x16, 686 rects.
...
/// `monitor_fx_byp_byp.png` — 42x16, 180 rects.
...
/// `monitor_fx_byp_off.png` — 42x16, 180 rects.
...
/// `monitor_fx_byp_on.png` — 42x16, 174 rects.
...
/// `monitor_fx_off.png` — 156x16, 686 rects.
...
/// `monitor_fx_on.png` — 156x16, 686 rects.
...
/// `piano_black_key.png` — 43x30, 152 rects.
...
/// `piano_black_key_sel.png` — 39x28, 160 rects.
...
/// `piano_white_key.png` — 39x20, 55 rects.
...
/// `piano_white_key_sel.png` — 39x20, 104 rects.
...
/// `scrollbar.png` — 204x238, 936 rects.
...
/// `tab_down_sel.png` — 33x18, 294 rects.
...
/// `tab_up_sel.png` — 33x18, 296 rects.
...
/// `table_expand_off.png` — 48x16, 21 rects.
...
/// `table_expand_on.png` — 48x16, 27 rects.
...
/// `table_locked_off.png` — 48x17, 30 rects.
...
/// `table_locked_on.png` — 48x17, 27 rects.
...
/// `table_locked_partial.png` — 48x17, 30 rects.
...
/// `table_mute_off.png` — 48x17, 162 rects.
...
/// `table_mute_on.png` — 48x16, 524 rects.
...
/// `table_recarm_off.png` — 48x17, 174 rects.
...
/// `table_recarm_on.png` — 48x16, 223 rects.
...
/// `table_remove_off.png` — 48x17, 216 rects.
...
/// `table_remove_on.png` — 48x17, 216 rects.
...
/// `table_solo_off.png` — 48x17, 156 rects.
...
/// `table_solo_on.png` — 48x17, 200 rects.
...
/// `table_sub_expand_off.png` — 48x16, 69 rects.
...
/// `table_sub_expand_on.png` — 48x16, 37 rects.
...
/// `table_target_invalid.png` — 48x16, 42 rects.
...
/// `table_target_off.png` — 48x16, 42 rects.
...
/// `table_target_on.png` — 48x16, 42 rects.
...
/// `table_visible_off.png` — 48x16, 48 rects.
...
/// `table_visible_on.png` — 48x16, 75 rects.
...
/// `table_visible_partial.png` — 48x17, 96 rects.
...
/// `tcp_fxparm_bg.png` — 10x10, 0 rects.
...
/// `tcp_fxparm_byp.png` — 38x56, 239 rects.
...
/// `tcp_fxparm_empty.png` — 38x56, 96 rects.
...
/// `tcp_fxparm_fx_byp.png` — 38x56, 161 rects.
...
/// `tcp_fxparm_fx_norm.png` — 38x56, 182 rects.
...
/// `tcp_fxparm_fx_off.png` — 38x56, 161 rects.
...
/// `tcp_fxparm_knob_stack.png` — 23x1150, 5036 rects.
...
/// `tcp_fxparm_norm.png` — 38x56, 239 rects.
...
/// `tcp_fxparm_off.png` — 38x56, 231 rects.
...
/// `tcp_iconbgsel.png` — 11x13, 2 rects.
...
/// `tcp_idxbg_sel.png` — 25x6, 5 rects.
...
/// `tcp_main_namebg_sel.png` — 3x3, 0 rects.
...
/// `tcp_mainbgsel.png` — 22x9, 1 rects.
...
/// `tcp_pan_knob_small.png` — 24x25, 245 rects.
...
/// `tcp_pan_knob_stack.png` — 18x1314, 2254 rects.
...
/// `tcp_panthumb.png` — 13x23, 81 rects.
...
/// `tcp_recinput.png` — 20x22, 43 rects.
...
/// `tcp_send_knob_stack.png` — 23x1150, 5036 rects.
...
/// `tcp_sendlist_bg.png` — 10x10, 0 rects.
...
/// `tcp_sendlist_empty.png` — 38x56, 163 rects.
...
/// `tcp_sendlist_meter.png` — 38x26, 34 rects.
...
/// `tcp_sendlist_midihw.png` — 34x56, 228 rects.
...
/// `tcp_sendlist_mute.png` — 34x56, 228 rects.
...
/// `tcp_sendlist_norm.png` — 34x56, 212 rects.
...
/// `tcp_solodefeat_on.png` — 65x24, 525 rects.
...
/// `tcp_vol_knob_small.png` — 26x28, 240 rects.
...
/// `tcp_vol_knob_stack.png` — 20x939, 7534 rects.
...
/// `tcp_volthumb.png` — 27x29, 72 rects.
...
/// `tcp_wid_knob_stack.png` — 18x1314, 3458 rects.
...
/// `tcp_width_knob_small.png` — 24x25, 245 rects.
...
/// `tcp_widthbg.png` — 43x11, 41 rects.
...
/// `tcp_widththumb.png` — 13x23, 81 rects.
...
/// `toolbar_add.png` — 90x30, 99 rects.
...
/// `toolbar_audio_waveform.png` — 90x30, 255 rects.
...
/// `toolbar_audio_waveform_delete_remove.png` — 90x30, 390 rects.
...
/// `toolbar_audio_waveform_delete_silence.png` — 90x30, 375 rects.
...
/// `toolbar_audio_waveform_digital_sample_rate.png` — 90x30, 108 rects.
...
/// `toolbar_audio_waveform_disk_load.png` — 90x30, 492 rects.
...
/// `toolbar_audio_waveform_folder.png` — 90x30, 264 rects.
...
/// `toolbar_audio_waveform_metronome.png` — 90x30, 444 rects.
...
/// `toolbar_audio_waveform_move_grid_quantize.png` — 90x30, 291 rects.
...
/// `toolbar_audio_waveform_normalize_gain.png` — 90x30, 339 rects.
...
/// `toolbar_audio_waveform_normalize_gain_common_locked.png` — 90x30, 300 rects.
...
/// `toolbar_audio_waveform_primary_external_editor.png` — 90x30, 195 rects.
...
/// `toolbar_audio_waveform_properties.png` — 90x30, 339 rects.
...
/// `toolbar_audio_waveform_render_disk_mono.png` — 90x30, 399 rects.
...
/// `toolbar_audio_waveform_render_disk_stereo.png` — 90x30, 504 rects.
...
/// `toolbar_audio_waveform_render_effects_mono.png` — 90x30, 402 rects.
...
/// `toolbar_audio_waveform_render_effects_stereo.png` — 90x30, 498 rects.
...
/// `toolbar_audio_waveform_reverse.png` — 90x30, 345 rects.
...
/// `toolbar_audio_waveform_secondary_external_editor.png` — 90x30, 204 rects.
...
/// `toolbar_audio_waveform_selection.png` — 90x30, 321 rects.
...
/// `toolbar_audio_waveform_selection_trim.png` — 90x30, 285 rects.
...
/// `toolbar_audio_waveform_system.png` — 90x30, 582 rects.
...
/// `toolbar_audio_waveform_time_selection_render.png` — 90x30, 318 rects.
...
/// `toolbar_audio_waveform_time_selection_render_stereo.png` — 90x30, 378 rects.
...
/// `toolbar_audio_waveform_transient_dynamic_split.png` — 90x30, 399 rects.
...
/// `toolbar_audio_waveform_transient_dynamic_split_lines.png` — 90x30, 393 rects.
...
/// `toolbar_audio_waveform_transient_dynamic_split_scissors.png` — 90x30, 543 rects.
...
/// `toolbar_bass_clef_note.png` — 90x30, 285 rects.
...
/// `toolbar_blank.png` — 90x30, 188 rects.
...
/// `toolbar_blank_inverted.png` — 90x30, 37 rects.
...
/// `toolbar_clip_properties.png` — 90x30, 549 rects.
...
/// `toolbar_clipboard_copy.png` — 90x30, 162 rects.
...
/// `toolbar_clipboard_cut.png` — 90x30, 132 rects.
...
/// `toolbar_clipboard_paste.png` — 90x30, 156 rects.
...
/// `toolbar_color_dynamic_volume_ff.png` — 90x30, 369 rects.
...
/// `toolbar_color_item.png` — 90x30, 303 rects.
...
/// `toolbar_color_item_selected.png` — 90x30, 296 rects.
...
/// `toolbar_color_load_disk.png` — 90x30, 342 rects.
...
/// `toolbar_color_midi_channel.png` — 90x30, 228 rects.
...
/// `toolbar_color_none_delete_remove.png` — 90x30, 201 rects.
...
/// `toolbar_color_note_pitch.png` — 90x30, 150 rects.
...
/// `toolbar_color_properties.png` — 90x30, 162 rects.
...
/// `toolbar_color_random_question.png` — 90x30, 252 rects.
...
/// `toolbar_color_region.png` — 90x30, 63 rects.
...
/// `toolbar_color_selecte_delete_remove.png` — 90x30, 54 rects.
...
/// `toolbar_color_selected.png` — 90x30, 54 rects.
...
/// `toolbar_color_source_input_channel.png` — 90x30, 144 rects.
...
/// `toolbar_color_sws_extension.png` — 90x30, 471 rects.
...
/// `toolbar_color_take_lane.png` — 90x30, 240 rects.
...
/// `toolbar_color_track.png` — 90x30, 282 rects.
...
/// `toolbar_cpu_offline.png` — 90x30, 204 rects.
...
/// `toolbar_cpu_online.png` — 90x30, 225 rects.
...
/// `toolbar_cpu_properties_performance.png` — 90x30, 177 rects.
...
/// `toolbar_delete.png` — 90x30, 231 rects.
...
/// `toolbar_disk_properties_resource_path.png` — 90x30, 318 rects.
...
/// `toolbar_dock.png` — 90x30, 234 rects.
...
/// `toolbar_dock_off.png` — 90x30, 488 rects.
...
/// `toolbar_dock_on.png` — 90x30, 488 rects.
...
/// `toolbar_dotted_note.png` — 90x30, 51 rects.
...
/// `toolbar_eighth_quaver_grid.png` — 90x30, 147 rects.
...
/// `toolbar_eighth_quaver_note.png` — 90x30, 111 rects.
...
/// `toolbar_env_auto_latch.png` — 90x30, 279 rects.
...
/// `toolbar_env_auto_preview.png` — 90x30, 336 rects.
...
/// `toolbar_env_auto_read.png` — 90x30, 282 rects.
...
/// `toolbar_env_auto_touch.png` — 90x30, 276 rects.
...
/// `toolbar_env_auto_trim.png` — 90x30, 249 rects.
...
/// `toolbar_env_auto_write.png` — 90x30, 288 rects.
...
/// `toolbar_envelope_copy.png` — 90x30, 486 rects.
...
/// `toolbar_envelope_delete_remove.png` — 90x30, 315 rects.
...
/// `toolbar_envelope_fade_shape_cycle.png` — 90x30, 339 rects.
...
/// `toolbar_envelope_fade_shape_none_default_delete_remove.png` — 90x30, 375 rects.
...
/// `toolbar_envelope_insert_four.png` — 90x30, 390 rects.
...
/// `toolbar_envelope_item_selected.png` — 90x30, 240 rects.
...
/// `toolbar_envelope_item_selected_replace.png` — 90x30, 240 rects.
...
/// `toolbar_envelope_knob_parameter_volume.png` — 90x30, 411 rects.
...
/// `toolbar_envelope_lock.png` — 90x30, 198 rects.
...
/// `toolbar_envelope_mute.png` — 90x30, 195 rects.
...
/// `toolbar_envelope_new.png` — 90x30, 276 rects.
...
/// `toolbar_envelope_pan.png` — 90x30, 204 rects.
...
/// `toolbar_envelope_pitch_note.png` — 90x30, 255 rects.
...
/// `toolbar_envelope_point_delete_remove.png` — 90x30, 204 rects.
...
/// `toolbar_envelope_point_insert.png` — 90x30, 297 rects.
...
/// `toolbar_envelope_point_move_axis.png` — 90x30, 372 rects.
...
/// `toolbar_envelope_point_move_down.png` — 90x30, 231 rects.
...
/// `toolbar_envelope_point_move_left.png` — 90x30, 243 rects.
...
/// `toolbar_envelope_point_move_right.png` — 90x30, 240 rects.
...
/// `toolbar_envelope_point_move_up.png` — 90x30, 231 rects.
...
/// `toolbar_envelope_point_new.png` — 90x30, 279 rects.
...
/// `toolbar_envelope_point_time_selection_cut_scissors.png` — 90x30, 276 rects.
...
/// `toolbar_envelope_point_time_selection_delete_remove.png` — 90x30, 270 rects.
...
/// `toolbar_envelope_reduce_number_points_delete_remove.png` — 90x30, 270 rects.
...
/// `toolbar_envelope_show.png` — 90x30, 324 rects.
...
/// `toolbar_envelope_tempo_time_clock.png` — 90x30, 416 rects.
...
/// `toolbar_envelope_time_selection.png` — 90x30, 147 rects.
...
/// `toolbar_envelope_vol.png` — 90x30, 177 rects.
...
/// `toolbar_envitem.png` — 90x30, 153 rects.
...
/// `toolbar_envitem_off.png` — 90x30, 430 rects.
...
/// `toolbar_envitem_on.png` — 90x30, 429 rects.
...
/// `toolbar_ex_autoplay.png` — 90x30, 408 rects.
...
/// `toolbar_ex_autoplay_off.png` — 90x30, 737 rects.
...
/// `toolbar_ex_autoplay_on.png` — 90x30, 737 rects.
...
/// `toolbar_ex_insert_open.png` — 90x30, 876 rects.
...
/// `toolbar_ex_pitch_detect.png` — 90x30, 558 rects.
...
/// `toolbar_ex_pitch_detect_off.png` — 90x30, 921 rects.
...
/// `toolbar_ex_pitch_detect_on.png` — 90x30, 921 rects.
...
/// `toolbar_ex_preserve_pitch_tempo_matching.png` — 90x30, 510 rects.
...
/// `toolbar_ex_preserve_pitch_tempo_matching_off.png` — 90x30, 880 rects.
...
/// `toolbar_ex_preserve_pitch_tempo_matching_on.png` — 90x30, 880 rects.
...
/// `toolbar_ex_properties_for_current_media.png` — 90x30, 339 rects.
...
/// `toolbar_ex_properties_for_current_media_off.png` — 90x30, 754 rects.
...
/// `toolbar_ex_properties_for_current_media_on.png` — 90x30, 754 rects.
...
/// `toolbar_ex_start_on_bar.png` — 90x30, 147 rects.
...
/// `toolbar_ex_start_on_bar_off.png` — 90x30, 455 rects.
...
/// `toolbar_ex_start_on_bar_on.png` — 90x30, 455 rects.
...
/// `toolbar_ex_tempo_match.png` — 90x30, 126 rects.
...
/// `toolbar_ex_tempo_match_double.png` — 90x30, 228 rects.
...
/// `toolbar_ex_tempo_match_double_off.png` — 90x30, 515 rects.
...
/// `toolbar_ex_tempo_match_double_on.png` — 90x30, 515 rects.
...
/// `toolbar_ex_tempo_match_half.png` — 90x30, 219 rects.
...
/// `toolbar_ex_tempo_match_half_off.png` — 90x30, 528 rects.
...
/// `toolbar_ex_tempo_match_half_on.png` — 90x30, 528 rects.
...
/// `toolbar_ex_tempo_match_off.png` — 90x30, 384 rects.
...
/// `toolbar_ex_tempo_match_on.png` — 90x30, 384 rects.
...
/// `toolbar_filter.png` — 90x30, 87 rects.
...
/// `toolbar_filter_off.png` — 90x30, 333 rects.
...
/// `toolbar_filter_on.png` — 90x30, 333 rects.
...
/// `toolbar_folder_add_implode.png` — 90x30, 177 rects.
...
/// `toolbar_folder_add_new.png` — 90x30, 36 rects.
...
/// `toolbar_folder_combine.png` — 90x30, 240 rects.
...
/// `toolbar_folder_delete_remove.png` — 90x30, 30 rects.
...
/// `toolbar_folder_hide.png` — 90x30, 210 rects.
...
/// `toolbar_folder_item_delete_remove.png` — 90x30, 135 rects.
...
/// `toolbar_folder_save_disk.png` — 90x30, 246 rects.
...
/// `toolbar_folder_seperate_explode.png` — 90x30, 177 rects.
...
/// `toolbar_folder_show_visible.png` — 90x30, 210 rects.
...
/// `toolbar_freeze_render_apply_snowflake.png` — 90x30, 654 rects.
...
/// `toolbar_glue.png` — 90x30, 276 rects.
...
/// `toolbar_glue_time_selection.png` — 90x30, 324 rects.
...
/// `toolbar_grid.png` — 90x30, 36 rects.
...
/// `toolbar_grid_adjust_decrease.png` — 90x30, 114 rects.
...
/// `toolbar_grid_adjust_increase.png` — 90x30, 120 rects.
...
/// `toolbar_grid_off.png` — 90x30, 290 rects.
...
/// `toolbar_grid_on.png` — 90x30, 290 rects.
...
/// `toolbar_group.png` — 90x30, 153 rects.
...
/// `toolbar_group_add_item.png` — 90x30, 516 rects.
...
/// `toolbar_group_add_item_selected.png` — 90x30, 546 rects.
...
/// `toolbar_group_explode.png` — 90x30, 783 rects.
...
/// `toolbar_group_off.png` — 90x30, 387 rects.
...
/// `toolbar_group_on.png` — 90x30, 387 rects.
...
/// `toolbar_group_record.png` — 90x30, 789 rects.
...
/// `toolbar_group_ungroup_remove_item.png` — 90x30, 510 rects.
...
/// `toolbar_group_ungroup_remove_item_selected.png` — 90x30, 546 rects.
...
/// `toolbar_half_minim_grid.png` — 90x30, 105 rects.
...
/// `toolbar_half_minim_note.png` — 90x30, 69 rects.
...
/// `toolbar_hide_mixer.png` — 90x30, 210 rects.
...
/// `toolbar_hide_selected.png` — 90x30, 192 rects.
...
/// `toolbar_hide_tcp.png` — 90x30, 210 rects.
...
/// `toolbar_input_fx_effect.png` — 90x30, 423 rects.
...
/// `toolbar_item_arpeggiate.png` — 90x30, 144 rects.
...
/// `toolbar_item_duplicate_copy.png` — 90x30, 99 rects.
...
/// `toolbar_item_effects_fx_delete_remove.png` — 90x30, 282 rects.
...
/// `toolbar_item_effects_fx_show.png` — 90x30, 324 rects.
...
/// `toolbar_item_explode_lane_take.png` — 90x30, 81 rects.
...
/// `toolbar_item_free_positioning.png` — 90x30, 24 rects.
...
/// `toolbar_item_green_arrow_selected.png` — 90x30, 66 rects.
...
/// `toolbar_item_green_arrow_selected_replace.png` — 90x30, 78 rects.
...
/// `toolbar_item_implode_lane_take.png` — 90x30, 81 rects.
...
/// `toolbar_item_insert_move_space.png` — 90x30, 123 rects.
...
/// `toolbar_item_left_edge_grow.png` — 90x30, 60 rects.
...
/// `toolbar_item_left_edge_position.png` — 90x30, 122 rects.
...
/// `toolbar_item_left_edge_shrink.png` — 90x30, 60 rects.
...
/// `toolbar_item_next.png` — 90x30, 63 rects.
...
/// `toolbar_item_previous.png` — 90x30, 63 rects.
...
/// `toolbar_item_properties.png` — 90x30, 159 rects.
...
/// `toolbar_item_red_arrow_selected.png` — 90x30, 66 rects.
...
/// `toolbar_item_remove_overlap.png` — 90x30, 81 rects.
...
/// `toolbar_item_right_edge_grow.png` — 90x30, 60 rects.
...
/// `toolbar_item_right_edge_position.png` — 90x30, 120 rects.
...
/// `toolbar_item_right_edge_shrink.png` — 90x30, 60 rects.
...
/// `toolbar_item_select.png` — 90x30, 213 rects.
...
/// `toolbar_item_select_all.png` — 90x30, 96 rects.
...
/// `toolbar_item_select_inverse.png` — 90x30, 96 rects.
...
/// `toolbar_item_selected_above_move.png` — 90x30, 312 rects.
...
/// `toolbar_item_selected_align.png` — 90x30, 207 rects.
...
/// `toolbar_item_selected_area_select_move.png` — 90x30, 210 rects.
...
/// `toolbar_item_selected_cut_scissors.png` — 90x30, 231 rects.
...
/// `toolbar_item_selected_grow_grid.png` — 90x30, 87 rects.
...
/// `toolbar_item_selected_move.png` — 90x30, 204 rects.
...
/// `toolbar_item_selected_move_end.png` — 90x30, 45 rects.
...
/// `toolbar_item_selected_move_horizontal_position_time.png` — 90x30, 264 rects.
...
/// `toolbar_item_selected_move_nudge_left.png` — 90x30, 261 rects.
...
/// `toolbar_item_selected_move_nudge_left_more.png` — 90x30, 435 rects.
...
/// `toolbar_item_selected_move_nudge_right.png` — 90x30, 261 rects.
...
/// `toolbar_item_selected_move_nudge_right_more.png` — 90x30, 435 rects.
...
/// `toolbar_item_selected_move_vertical_track.png` — 90x30, 258 rects.
...
/// `toolbar_item_selected_snap.png` — 90x30, 99 rects.
...
/// `toolbar_item_selected_swap.png` — 90x30, 138 rects.
...
/// `toolbar_item_selected_take_delete.png` — 90x30, 237 rects.
...
/// `toolbar_item_selected_take_delete_invert.png` — 90x30, 237 rects.
...
/// `toolbar_item_selected_take_extract.png` — 90x30, 120 rects.
...
/// `toolbar_item_selected_take_insert.png` — 90x30, 120 rects.
...
/// `toolbar_item_selected_take_move_down.png` — 90x30, 126 rects.
...
/// `toolbar_item_selected_take_move_top.png` — 90x30, 186 rects.
...
/// `toolbar_item_selected_take_move_up.png` — 90x30, 129 rects.
...
/// `toolbar_item_selection_remove_contents_move_later.png` — 90x30, 192 rects.
...
/// `toolbar_item_source_preferred_position_properties.png` — 90x30, 156 rects.
...
/// `toolbar_item_take.png` — 90x30, 39 rects.
...
/// `toolbar_item_take_explode.png` — 90x30, 225 rects.
...
/// `toolbar_item_take_selected_extract.png` — 90x30, 90 rects.
...
/// `toolbar_item_take_selected_lock.png` — 90x30, 75 rects.
...
/// `toolbar_jog_back_rewind_little_bit.png` — 90x30, 465 rects.
...
/// `toolbar_jog_forward_little_bit.png` — 90x30, 471 rects.
...
/// `toolbar_knob_parameter_learn_lock.png` — 90x30, 504 rects.
...
/// `toolbar_knob_parameter_visible_show.png` — 90x30, 426 rects.
...
/// `toolbar_load.png` — 90x30, 401 rects.
...
/// `toolbar_lock.png` — 90x30, 78 rects.
...
/// `toolbar_lock_off.png` — 90x30, 304 rects.
...
/// `toolbar_lock_on.png` — 90x30, 304 rects.
...
/// `toolbar_marker_delete_remove.png` — 90x30, 186 rects.
...
/// `toolbar_marker_insert_new.png` — 90x30, 57 rects.
...
/// `toolbar_marker_list.png` — 90x30, 186 rects.
...
/// `toolbar_marker_load_disk.png` — 90x30, 393 rects.
...
/// `toolbar_marker_lock.png` — 90x30, 114 rects.
...
/// `toolbar_marker_next.png` — 90x30, 111 rects.
...
/// `toolbar_marker_previous.png` — 90x30, 111 rects.
...
/// `toolbar_marker_properties.png` — 90x30, 159 rects.
...
/// `toolbar_marker_renum.png` — 90x30, 298 rects.
...
/// `toolbar_marker_time_selection_delete_remoe.png` — 90x30, 234 rects.
...
/// `toolbar_marker_time_tempo_delete_remove.png` — 90x30, 291 rects.
...
/// `toolbar_marker_time_tempo_insert_new.png` — 90x30, 162 rects.
...
/// `toolbar_marker_time_tempo_next.png` — 90x30, 231 rects.
...
/// `toolbar_marker_time_tempo_previous.png` — 90x30, 231 rects.
...
/// `toolbar_marker_time_tempo_properties.png` — 90x30, 264 rects.
...
/// `toolbar_marquee_cursor_selection.png` — 90x30, 69 rects.
...
/// `toolbar_marquee_cursor_selection_off.png` — 90x30, 355 rects.
...
/// `toolbar_marquee_cursor_selection_on.png` — 90x30, 355 rects.
...
/// `toolbar_metro.png` — 90x30, 234 rects.
...
/// `toolbar_metro_off.png` — 90x30, 549 rects.
...
/// `toolbar_metro_on.png` — 90x30, 549 rects.
...
/// `toolbar_midi_all.png` — 90x30, 21 rects.
...
/// `toolbar_midi_cc_above.png` — 90x30, 24 rects.
...
/// `toolbar_midi_cc_below.png` — 90x30, 24 rects.
...
/// `toolbar_midi_cc_explode.png` — 90x30, 507 rects.
...
/// `toolbar_midi_cc_pitch_bend.png` — 90x30, 408 rects.
...
/// `toolbar_midi_cc_scale_slope.png` — 90x30, 111 rects.
...
/// `toolbar_midi_cc_selected_decrease.png` — 90x30, 48 rects.
...
/// `toolbar_midi_cc_selected_increase.png` — 90x30, 48 rects.
...
/// `toolbar_midi_cc_set_scale_fix.png` — 90x30, 93 rects.
...
/// `toolbar_midi_delete_remove_none.png` — 90x30, 435 rects.
...
/// `toolbar_midi_envelope.png` — 90x30, 303 rects.
...
/// `toolbar_midi_events_mode_cycle.png` — 90x30, 261 rects.
...
/// `toolbar_midi_events_mode_drum_diamond.png` — 90x30, 712 rects.
...
/// `toolbar_midi_events_mode_drum_triangle.png` — 90x30, 655 rects.
...
/// `toolbar_midi_events_mode_normal_rectangle.png` — 90x30, 563 rects.
...
/// `toolbar_midi_folder.png` — 90x30, 186 rects.
...
/// `toolbar_midi_hide_unused_note_rows.png` — 90x30, 384 rects.
...
/// `toolbar_midi_hide_unused_unnamed_note_rows.png` — 90x30, 384 rects.
...
/// `toolbar_midi_item.png` — 90x30, 219 rects.
...
/// `toolbar_midi_item_selected.png` — 90x30, 294 rects.
...
/// `toolbar_midi_item_selected-262.png` — 90x30, 213 rects.
...
/// `toolbar_midi_itemsel.png` — 90x30, 63 rects.
...
/// `toolbar_midi_itemsel_off.png` — 90x30, 325 rects.
...
/// `toolbar_midi_itemsel_on.png` — 90x30, 325 rects.
...
/// `toolbar_midi_lengthen_note_grid_unit.png` — 90x30, 99 rects.
...
/// `toolbar_midi_lengthen_note_pixel.png` — 90x30, 141 rects.
...
/// `toolbar_midi_list.png` — 90x30, 258 rects.
...
/// `toolbar_midi_mode_event_list.png` — 90x30, 244 rects.
...
/// `toolbar_midi_mode_musical_notation.png` — 90x30, 625 rects.
...
/// `toolbar_midi_mode_named_notes.png` — 90x30, 217 rects.
...
/// `toolbar_midi_mode_piano_roll.png` — 90x30, 256 rects.
...
/// `toolbar_midi_notes_force_snap_scale.png` — 90x30, 24 rects.
...
/// `toolbar_midi_panic_all_notes.png` — 90x30, 345 rects.
...
/// `toolbar_midi_pitch_decrease_octave.png` — 90x30, 312 rects.
...
/// `toolbar_midi_pitch_decrease_semitone.png` — 90x30, 150 rects.
...
/// `toolbar_midi_pitch_increase_octave.png` — 90x30, 303 rects.
...
/// `toolbar_midi_pitch_increase_octave-173.png` — 90x30, 303 rects.
...
/// `toolbar_midi_pitch_increase_semitone.png` — 90x30, 150 rects.
...
/// `toolbar_midi_pitch_transpose.png` — 90x30, 189 rects.
...
/// `toolbar_midi_properties.png` — 90x30, 372 rects.
...
/// `toolbar_midi_render_apply_audio_waveform.png` — 90x30, 420 rects.
...
/// `toolbar_midi_shorten_note_grid_unit.png` — 90x30, 99 rects.
...
/// `toolbar_midi_shorten_note_pixel.png` — 90x30, 141 rects.
...
/// `toolbar_midi_show_all_note_rows.png` — 90x30, 384 rects.
...
/// `toolbar_midi_size_full.png` — 90x30, 219 rects.
...
/// `toolbar_midi_step.png` — 90x30, 549 rects.
...
/// `toolbar_midi_tracksel.png` — 90x30, 36 rects.
...
/// `toolbar_midi_tracksel_off.png` — 90x30, 310 rects.
...
/// `toolbar_midi_tracksel_on.png` — 90x30, 310 rects.
...
/// `toolbar_midi_waveform_audio.png` — 90x30, 354 rects.
...
/// `toolbar_midi_zoom.png` — 90x30, 342 rects.
...
/// `toolbar_misc_anarchy.png` — 90x30, 468 rects.
...
/// `toolbar_misc_anchor.png` — 90x30, 240 rects.
...
/// `toolbar_misc_back_left_previous.png` — 90x30, 126 rects.
...
/// `toolbar_misc_back_left_previous_more.png` — 90x30, 324 rects.
...
/// `toolbar_misc_bash.png` — 90x30, 465 rects.
...
/// `toolbar_misc_bomb.png` — 90x30, 276 rects.
...
/// `toolbar_misc_brush_broom_clean.png` — 90x30, 159 rects.
...
/// `toolbar_misc_bulb_idea.png` — 90x30, 288 rects.
...
/// `toolbar_misc_calculate_numeric.png` — 90x30, 57 rects.
...
/// `toolbar_misc_car.png` — 90x30, 171 rects.
...
/// `toolbar_misc_coffee.png` — 90x30, 186 rects.
...
/// `toolbar_misc_devil.png` — 90x30, 171 rects.
...
/// `toolbar_misc_down_next.png` — 90x30, 117 rects.
...
/// `toolbar_misc_down_next_more.png` — 90x30, 297 rects.
...
/// `toolbar_misc_drum.png` — 90x30, 309 rects.
...
/// `toolbar_misc_duck.png` — 90x30, 228 rects.
...
/// `toolbar_misc_explode.png` — 90x30, 324 rects.
...
/// `toolbar_misc_filter.png` — 90x30, 201 rects.
...
/// `toolbar_misc_finger.png` — 90x30, 63 rects.
...
/// `toolbar_misc_firewire.png` — 90x30, 285 rects.
...
/// `toolbar_misc_game.png` — 90x30, 57 rects.
...
/// `toolbar_misc_guitar.png` — 90x30, 314 rects.
...
/// `toolbar_misc_guitar_headstock.png` — 90x30, 345 rects.
...
/// `toolbar_misc_gun.png` — 90x30, 99 rects.
...
/// `toolbar_misc_heart.png` — 90x30, 165 rects.
...
/// `toolbar_misc_horns.png` — 90x30, 57 rects.
...
/// `toolbar_misc_house_home.png` — 90x30, 90 rects.
...
/// `toolbar_misc_ibeam_cursor_selection.png` — 90x30, 15 rects.
...
/// `toolbar_misc_jack_input_output.png` — 90x30, 258 rects.
...
/// `toolbar_misc_key_lock.png` — 90x30, 78 rects.
...
/// `toolbar_misc_keyboard.png` — 90x30, 24 rects.
...
/// `toolbar_misc_lips.png` — 90x30, 210 rects.
...
/// `toolbar_misc_mask.png` — 90x30, 249 rects.
...
/// `toolbar_misc_mic.png` — 90x30, 183 rects.
...
/// `toolbar_misc_mixer_control.png` — 90x30, 81 rects.
...
/// `toolbar_misc_monitor_speaker.png` — 90x30, 132 rects.
...
/// `toolbar_misc_mouse.png` — 90x30, 213 rects.
...
/// `toolbar_misc_mouse_left_click.png` — 90x30, 213 rects.
...
/// `toolbar_misc_mouse_right_click.png` — 90x30, 213 rects.
...
/// `toolbar_misc_network_stream.png` — 90x30, 48 rects.
...
/// `toolbar_misc_phones.png` — 90x30, 153 rects.
...
/// `toolbar_misc_pointer_cursor.png` — 90x30, 72 rects.
...
/// `toolbar_misc_pointer_cursor_white.png` — 90x30, 96 rects.
...
/// `toolbar_misc_question_random.png` — 90x30, 189 rects.
...
/// `toolbar_misc_radioactive.png` — 90x30, 513 rects.
...
/// `toolbar_misc_right_forward_next.png` — 90x30, 126 rects.
...
/// `toolbar_misc_right_forward_next_more.png` — 90x30, 324 rects.
...
/// `toolbar_misc_run_backward.png` — 90x30, 240 rects.
...
/// `toolbar_misc_run_forward.png` — 90x30, 240 rects.
...
/// `toolbar_misc_saint.png` — 90x30, 225 rects.
...
/// `toolbar_misc_skull_crossbones.png` — 90x30, 414 rects.
...
/// `toolbar_misc_speech_note.png` — 90x30, 177 rects.
...
/// `toolbar_misc_star.png` — 90x30, 318 rects.
...
/// `toolbar_misc_star_green.png` — 90x30, 192 rects.
...
/// `toolbar_misc_system_reaper.png` — 90x30, 438 rects.
...
/// `toolbar_misc_tape.png` — 90x30, 315 rects.
...
/// `toolbar_misc_tea_mmmmm_tea.png` — 90x30, 144 rects.
...
/// `toolbar_misc_thought_idea.png` — 90x30, 219 rects.
...
/// `toolbar_misc_toilet.png` — 90x30, 48 rects.
...
/// `toolbar_misc_trash_bin.png` — 90x30, 177 rects.
...
/// `toolbar_misc_up_previous.png` — 90x30, 117 rects.
...
/// `toolbar_misc_up_previous_more.png` — 90x30, 297 rects.
...
/// `toolbar_misc_usb.png` — 90x30, 195 rects.
...
/// `toolbar_misc_walk_backward.png` — 90x30, 261 rects.
...
/// `toolbar_misc_walk_forward.png` — 90x30, 261 rects.
...
/// `toolbar_mute_envelope.png` — 90x30, 309 rects.
...
/// `toolbar_mute_none_unmute.png` — 90x30, 339 rects.
...
/// `toolbar_new.png` — 90x30, 262 rects.
...
/// `toolbar_note_gliss_slide.png` — 90x30, 168 rects.
...
/// `toolbar_note_tie.png` — 90x30, 159 rects.
...
/// `toolbar_parameter_scrub.png` — 90x30, 513 rects.
...
/// `toolbar_path_primary_disk.png` — 90x30, 462 rects.
...
/// `toolbar_path_primary_secondary_both_disk.png` — 90x30, 462 rects.
...
/// `toolbar_path_secondary_disk.png` — 90x30, 462 rects.
...
/// `toolbar_pitch_preserve_lock.png` — 90x30, 336 rects.
...
/// `toolbar_preroll_clock.png` — 90x30, 454 rects.
...
/// `toolbar_preroll_clock_record.png` — 90x30, 587 rects.
...
/// `toolbar_project_save_as_new_disk.png` — 90x30, 418 rects.
...
/// `toolbar_project_unused_delete_remove_disk.png` — 90x30, 342 rects.
...
/// `toolbar_projprop.png` — 90x30, 663 rects.
...
/// `toolbar_quant.png` — 90x30, 396 rects.
...
/// `toolbar_quant_off.png` — 90x30, 793 rects.
...
/// `toolbar_quant_on.png` — 90x30, 793 rects.
...
/// `toolbar_quarter_crotchet_grid.png` — 90x30, 81 rects.
...
/// `toolbar_quarter_crotchet_note.png` — 90x30, 45 rects.
...
/// `toolbar_razor_off.png` — 90x30, 767 rects.
...
/// `toolbar_razor_on.png` — 90x30, 767 rects.
...
/// `toolbar_record.png` — 90x30, 975 rects.
...
/// `toolbar_record_arm_all.png` — 90x30, 501 rects.
...
/// `toolbar_record_create_item_seperate_lane.png` — 90x30, 264 rects.
...
/// `toolbar_record_loop_time_selection.png` — 90x30, 270 rects.
...
/// `toolbar_record_next_beat_measure.png` — 90x30, 198 rects.
...
/// `toolbar_record_next_marker.png` — 90x30, 234 rects.
...
/// `toolbar_record_properties.png` — 90x30, 279 rects.
...
/// `toolbar_record_selected_item_auto_punch.png` — 90x30, 186 rects.
...
/// `toolbar_record_split_item_new_take.png` — 90x30, 234 rects.
...
/// `toolbar_record_stop_delete.png` — 90x30, 342 rects.
...
/// `toolbar_record_stop_save.png` — 90x30, 360 rects.
...
/// `toolbar_record_time_selection_auto_punch.png` — 90x30, 225 rects.
...
/// `toolbar_record_time_selection_selected_item_auto_punch.png` — 90x30, 222 rects.
...
/// `toolbar_record_trim_item_behind_tape.png` — 90x30, 528 rects.
...
/// `toolbar_redo.png` — 90x30, 392 rects.
...
/// `toolbar_region_delete_remove_none.png` — 90x30, 348 rects.
...
/// `toolbar_region_new.png` — 90x30, 186 rects.
...
/// `toolbar_region_next.png` — 90x30, 213 rects.
...
/// `toolbar_region_play_loop.png` — 90x30, 351 rects.
...
/// `toolbar_region_previous.png` — 90x30, 213 rects.
...
/// `toolbar_region_properties.png` — 90x30, 237 rects.
...
/// `toolbar_region_time_selection.png` — 90x30, 273 rects.
...
/// `toolbar_relsnap.png` — 90x30, 150 rects.
...
/// `toolbar_relsnap_off.png` — 90x30, 432 rects.
...
/// `toolbar_relsnap_on.png` — 90x30, 432 rects.
...
/// `toolbar_remove_scissors_selection.png` — 90x30, 330 rects.
...
/// `toolbar_remove_selection_none.png` — 90x30, 150 rects.
...
/// `toolbar_render_effects_midi.png` — 90x30, 366 rects.
...
/// `toolbar_replacemode.png` — 90x30, 253 rects.
...
/// `toolbar_revert.png` — 90x30, 637 rects.
...
/// `toolbar_ripple.png` — 90x30, 99 rects.
...
/// `toolbar_ripple_all.png` — 90x30, 308 rects.
...
/// `toolbar_ripple_off.png` — 90x30, 373 rects.
...
/// `toolbar_ripple_on.png` — 90x30, 373 rects.
...
/// `toolbar_ripple_one.png` — 90x30, 210 rects.
...
/// `toolbar_save.png` — 90x30, 369 rects.
...
/// `toolbar_screenset_camera_list.png` — 90x30, 207 rects.
...
/// `toolbar_screenset_camera_new.png` — 90x30, 201 rects.
...
/// `toolbar_screenset_camera_next.png` — 90x30, 333 rects.
...
/// `toolbar_screenset_camera_previous.png` — 90x30, 333 rects.
...
/// `toolbar_screenset_camera_save_disk.png` — 90x30, 402 rects.
...
/// `toolbar_selection_delete_remove.png` — 90x30, 156 rects.
...
/// `toolbar_selection_inverse_delete_remove.png` — 90x30, 156 rects.
...
/// `toolbar_send_hide_mute.png` — 90x30, 354 rects.
...
/// `toolbar_send_show_enable.png` — 90x30, 411 rects.
...
/// `toolbar_shape_bezier.png` — 90x30, 135 rects.
...
/// `toolbar_shape_fast_end.png` — 90x30, 144 rects.
...
/// `toolbar_shape_fast_start.png` — 90x30, 144 rects.
...
/// `toolbar_shape_linear.png` — 90x30, 198 rects.
...
/// `toolbar_shape_square.png` — 90x30, 9 rects.
...
/// `toolbar_show.png` — 90x30, 342 rects.
...
/// `toolbar_show selected.png` — 90x30, 192 rects.
...
/// `toolbar_show_insert.png` — 90x30, 162 rects.
...
/// `toolbar_show_parameter.png` — 90x30, 396 rects.
...
/// `toolbar_show_send.png` — 90x30, 225 rects.
...
/// `toolbar_shuttle_back_rewind.png` — 90x30, 468 rects.
...
/// `toolbar_shuttle_forward.png` — 90x30, 474 rects.
...
/// `toolbar_sixteenth_semiquaver_grid.png` — 90x30, 177 rects.
...
/// `toolbar_sixteenth_semiquaver_note.png` — 90x30, 141 rects.
...
/// `toolbar_snap.png` — 90x30, 135 rects.
...
/// `toolbar_snap_off.png` — 90x30, 399 rects.
...
/// `toolbar_snap_offset_grid_move.png` — 90x30, 126 rects.
...
/// `toolbar_snap_on.png` — 90x30, 399 rects.
...
/// `toolbar_solo_in_front_dim.png` — 90x30, 336 rects.
...
/// `toolbar_solo_none_unsolo.png` — 90x30, 414 rects.
...
/// `toolbar_split_scissors.png` — 90x30, 309 rects.
...
/// `toolbar_stretch_marker_delete_remove.png` — 90x30, 246 rects.
...
/// `toolbar_stretch_marker_insert_new_add.png` — 90x30, 126 rects.
...
/// `toolbar_stretch_marker_locking.png` — 90x30, 171 rects.
...
/// `toolbar_stretch_marker_next.png` — 90x30, 174 rects.
...
/// `toolbar_stretch_marker_previous.png` — 90x30, 174 rects.
...
/// `toolbar_stretch_marker_snap_grid.png` — 90x30, 240 rects.
...
/// `toolbar_stretch_marker_time_selection_delete_remove.png` — 90x30, 165 rects.
...
/// `toolbar_stretch_marker_time_selection_new_add.png` — 90x30, 165 rects.
...
/// `toolbar_stretch_marker_tonal.png` — 90x30, 228 rects.
...
/// `toolbar_sws_extension.png` — 90x30, 453 rects.
...
/// `toolbar_sws_extension_properties.png` — 90x30, 543 rects.
...
/// `toolbar_sync_follow_play.png` — 90x30, 480 rects.
...
/// `toolbar_sync_follow_record.png` — 90x30, 621 rects.
...
/// `toolbar_system_external.png` — 90x30, 399 rects.
...
/// `toolbar_system_properties.png` — 90x30, 471 rects.
...
/// `toolbar_system_set_save_default_disk.png` — 90x30, 576 rects.
...
/// `toolbar_theme_next.png` — 90x30, 270 rects.
...
/// `toolbar_theme_previous.png` — 90x30, 270 rects.
...
/// `toolbar_theme_refresh.png` — 90x30, 262 rects.
...
/// `toolbar_thirty_second_demisemiquaver_.png` — 90x30, 150 rects.
...
/// `toolbar_thirty_second_demisemiquaver_grid.png` — 90x30, 186 rects.
...
/// `toolbar_time_beats.png` — 90x30, 276 rects.
...
/// `toolbar_time_clock.png` — 90x30, 431 rects.
...
/// `toolbar_time_clock_properties.png` — 90x30, 456 rects.
...
/// `toolbar_time_hourglass.png` — 90x30, 210 rects.
...
/// `toolbar_time_hours.png` — 90x30, 672 rects.
...
/// `toolbar_time_measures.png` — 90x30, 276 rects.
...
/// `toolbar_time_minutes.png` — 90x30, 636 rects.
...
/// `toolbar_time_sample.png` — 90x30, 276 rects.
...
/// `toolbar_time_seconds.png` — 90x30, 648 rects.
...
/// `toolbar_time_selection_delete_remove.png` — 90x30, 213 rects.
...
/// `toolbar_time_selection_fit_item_selected.png` — 90x30, 93 rects.
...
/// `toolbar_time_selection_item_cut.png` — 90x30, 275 rects.
...
/// `toolbar_time_selection_item_delete_remove.png` — 90x30, 207 rects.
...
/// `toolbar_time_selection_item_selected_grow_expand.png` — 90x30, 93 rects.
...
/// `toolbar_time_selection_left.png` — 90x30, 48 rects.
...
/// `toolbar_time_selection_loop_lock.png` — 90x30, 204 rects.
...
/// `toolbar_time_selection_loop_play.png` — 90x30, 225 rects.
...
/// `toolbar_time_selection_new.png` — 90x30, 135 rects.
...
/// `toolbar_time_selection_play.png` — 90x30, 108 rects.
...
/// `toolbar_time_selection_properties.png` — 90x30, 168 rects.
...
/// `toolbar_time_selection_region.png` — 90x30, 198 rects.
...
/// `toolbar_time_selection_right.png` — 90x30, 48 rects.
...
/// `toolbar_time_stretch.png` — 90x30, 405 rects.
...
/// `toolbar_timebase_beats_position.png` — 90x30, 87 rects.
...
/// `toolbar_timebase_beats_position_length_rate.png` — 90x30, 87 rects.
...
/// `toolbar_timebase_time.png` — 90x30, 416 rects.
...
/// `toolbar_tool_brush_paint.png` — 90x30, 174 rects.
...
/// `toolbar_tool_crop.png` — 90x30, 93 rects.
...
/// `toolbar_tool_erase_delete_remove.png` — 90x30, 228 rects.
...
/// `toolbar_tool_hammer.png` — 90x30, 252 rects.
...
/// `toolbar_tool_knife_trim.png` — 90x30, 204 rects.
...
/// `toolbar_tool_pencil_draw.png` — 90x30, 333 rects.
...
/// `toolbar_tool_razor_blade.png` — 90x30, 245 rects.
...
/// `toolbar_tool_scissors_cut_trim.png` — 90x30, 288 rects.
...
/// `toolbar_track_next.png` — 90x30, 84 rects.
...
/// `toolbar_track_previous.png` — 90x30, 84 rects.
...
/// `toolbar_transport_home_end.png` — 90x30, 309 rects.
...
/// `toolbar_treble_clef_note.png` — 90x30, 300 rects.
...
/// `toolbar_trim_scissors_selection.png` — 90x30, 318 rects.
...
/// `toolbar_triplet_note.png` — 90x30, 96 rects.
...
/// `toolbar_undo.png` — 90x30, 392 rects.
...
/// `toolbar_unfreeze_render_apply_snowflake.png` — 90x30, 690 rects.
...
/// `toolbar_v3_envitem.png` — 90x30, 102 rects.
...
/// `toolbar_v3_grid.png` — 90x30, 45 rects.
...
/// `toolbar_v3_group.png` — 90x30, 162 rects.
...
/// `toolbar_v3_load.png` — 90x30, 216 rects.
...
/// `toolbar_v3_lock.png` — 90x30, 78 rects.
...
/// `toolbar_v3_metro.png` — 90x30, 153 rects.
...
/// `toolbar_v3_new.png` — 90x30, 198 rects.
...
/// `toolbar_v3_projprop.png` — 90x30, 201 rects.
...
/// `toolbar_v3_redo.png` — 90x30, 273 rects.
...
/// `toolbar_v3_ripple.png` — 90x30, 27 rects.
...
/// `toolbar_v3_ripple_all.png` — 90x30, 27 rects.
...
/// `toolbar_v3_ripple_one.png` — 90x30, 27 rects.
...
/// `toolbar_v3_save.png` — 90x30, 246 rects.
...
/// `toolbar_v3_snap.png` — 90x30, 207 rects.
...
/// `toolbar_v3_undo.png` — 90x30, 270 rects.
...
/// `toolbar_v3_xfade.png` — 90x30, 6 rects.
...
/// `toolbar_video_item_selected.png` — 90x30, 183 rects.
...
/// `toolbar_video_properties.png` — 90x30, 219 rects.
...
/// `toolbar_video_screen.png` — 90x30, 102 rects.
...
/// `toolbar_video_sync_start.png` — 90x30, 126 rects.
...
/// `toolbar_visible_mixer.png` — 90x30, 210 rects.
...
/// `toolbar_visible_tcp.png` — 90x30, 210 rects.
...
/// `toolbar_whole_semibreve_grid.png` — 90x30, 96 rects.
...
/// `toolbar_whole_semibreve_note.png` — 90x30, 60 rects.
...
/// `toolbar_window_floating_toolbar.png` — 90x30, 315 rects.
...
/// `toolbar_window_fullscreen.png` — 90x30, 264 rects.
...
/// `toolbar_window_tab_background_synchronize.png` — 90x30, 165 rects.
...
/// `toolbar_window_tab_clip.png` — 90x30, 492 rects.
...
/// `toolbar_window_tab_clock.png` — 90x30, 468 rects.
...
/// `toolbar_window_tab_delete_remove.png` — 90x30, 354 rects.
...
/// `toolbar_window_tab_docker_bottom.png` — 90x30, 48 rects.
...
/// `toolbar_window_tab_docker_left.png` — 90x30, 48 rects.
...
/// `toolbar_window_tab_docker_right.png` — 90x30, 48 rects.
...
/// `toolbar_window_tab_docker_show.png` — 90x30, 375 rects.
...
/// `toolbar_window_tab_docker_top.png` — 90x30, 48 rects.
...
/// `toolbar_window_tab_effects.png` — 90x30, 285 rects.
...
/// `toolbar_window_tab_folder.png` — 90x30, 120 rects.
...
/// `toolbar_window_tab_list.png` — 90x30, 153 rects.
...
/// `toolbar_window_tab_midi_editor.png` — 90x30, 336 rects.
...
/// `toolbar_window_tab_mixer_mcp.png` — 90x30, 108 rects.
...
/// `toolbar_window_tab_mixer_tcp.png` — 90x30, 120 rects.
...
/// `toolbar_window_tab_navigator.png` — 90x30, 393 rects.
...
/// `toolbar_window_tab_new.png` — 90x30, 348 rects.
...
/// `toolbar_window_tab_new_background.png` — 90x30, 279 rects.
...
/// `toolbar_window_tab_next_background.png` — 90x30, 81 rects.
...
/// `toolbar_window_tab_performance.png` — 90x30, 138 rects.
...
/// `toolbar_window_tab_properties.png` — 90x30, 291 rects.
...
/// `toolbar_window_tab_region.png` — 90x30, 81 rects.
...
/// `toolbar_window_tab_routing_matrix.png` — 90x30, 120 rects.
...
/// `toolbar_window_tab_screenset_layout.png` — 90x30, 204 rects.
...
/// `toolbar_window_tab_undo_history.png` — 90x30, 412 rects.
...
/// `toolbar_window_tab_video.png` — 90x30, 219 rects.
...
/// `toolbar_xfade.png` — 90x30, 210 rects.
...
/// `toolbar_xfade_off.png` — 90x30, 507 rects.
...
/// `toolbar_xfade_on.png` — 90x30, 507 rects.
...
/// `toolbar_zoom_all.png` — 90x30, 309 rects.
...
/// `toolbar_zoom_in_audio_waveform.png` — 90x30, 387 rects.
...
/// `toolbar_zoom_in_selected_item.png` — 90x30, 201 rects.
...
/// `toolbar_zoom_out_all.png` — 90x30, 447 rects.
...
/// `toolbar_zoom_out_audio_waveform.png` — 90x30, 381 rects.
...
/// `toolbar_zoom_project.png` — 90x30, 219 rects.
...
/// `toolbar_zoom_region.png` — 90x30, 279 rects.
...
/// `toolbar_zoom_selected.png` — 90x30, 285 rects.
...
/// `toolbar_zoom_selected item.png` — 90x30, 288 rects.
...
/// `toolbar_zoom_time_selection.png` — 90x30, 231 rects.
...
/// `toosmall_b.png` — 16x16, 124 rects.
...
/// `track_env_latch.png` — 60x20, 249 rects.
...
/// `track_env_preview.png` — 60x20, 288 rects.
...
/// `track_env_read.png` — 60x20, 306 rects.
...
/// `track_env_touch.png` — 60x20, 270 rects.
...
/// `track_env_write.png` — 60x20, 369 rects.
...
/// `track_fcomp_off.png` — 51x13, 201 rects.
...
/// `track_fcomp_small.png` — 51x13, 187 rects.
...
/// `track_fcomp_tiny.png` — 51x13, 203 rects.
...
/// `track_folder_last.png` — 54x14, 92 rects.
...
/// `track_folder_off.png` — 54x14, 8 rects.
...
/// `track_folder_on.png` — 54x14, 176 rects.
...
/// `track_fx_dis.png` — 62x22, 411 rects.
...
/// `track_fx_empty.png` — 62x22, 402 rects.
...
/// `track_fx_in_empty.png` — 87x20, 226 rects.
...
/// `track_fx_in_norm.png` — 88x20, 300 rects.
...
/// `track_fx_norm.png` — 62x22, 405 rects.
...
/// `track_fxempty_h.png` — 50x22, 251 rects.
...
/// `track_fxempty_v.png` — 56x22, 225 rects.
...
/// `track_fxoff_h.png` — 50x22, 261 rects.
...
/// `track_fxoff_v.png` — 56x22, 258 rects.
...
/// `track_fxon_h.png` — 50x22, 270 rects.
...
/// `track_fxon_v.png` — 56x22, 273 rects.
...
/// `track_io_dis.png` — 86x22, 521 rects.
...
/// `track_io_r.png` — 86x22, 521 rects.
...
/// `track_io_r_dis.png` — 86x22, 521 rects.
...
/// `track_io_s.png` — 86x22, 521 rects.
...
/// `track_io_s_dis.png` — 86x22, 521 rects.
...
/// `track_io_s_r.png` — 86x22, 521 rects.
...
/// `track_io_s_r_dis.png` — 86x22, 521 rects.
...
/// `track_monitor_auto.png` — 47x24, 248 rects.
...
/// `track_monitor_off.png` — 47x24, 306 rects.
...
/// `track_monitor_on.png` — 47x24, 225 rects.
...
/// `track_mono.png` — 150x20, 1381 rects.
...
/// `track_mute_off.png` — 65x24, 394 rects.
...
/// `track_mute_on.png` — 65x24, 688 rects.
...
/// `track_phase_inv.png` — 48x20, 518 rects.
...
/// `track_phase_norm.png` — 48x20, 495 rects.
...
/// `track_recarm_auto.png` — 60x20, 342 rects.
...
/// `track_recarm_auto_norec.png` — 60x20, 369 rects.
...
/// `track_recarm_auto_on.png` — 60x20, 369 rects.
...
/// `track_recarm_norec.png` — 60x20, 364 rects.
...
/// `track_recarm_off.png` — 60x20, 264 rects.
...
/// `track_recarm_on.png` — 60x20, 318 rects.
...
/// `track_recmode_in.png` — 60x20, 185 rects.
...
/// `track_recmode_off.png` — 60x20, 360 rects.
...
/// `track_recmode_out.png` — 60x20, 205 rects.
...
/// `track_solo_off.png` — 65x24, 454 rects.
...
/// `track_solo_on.png` — 65x24, 499 rects.
...
/// `track_solodefeat_on.png` — 65x24, 525 rects.
...
/// `track_stereo.png` — 150x20, 920 rects.
...
/// `transport_bg.png` — 200x67, 66 rects.
...
/// `transport_bpm.png` — 92x26, 62 rects.
...
/// `transport_bpm_bg.png` — 6x10, 0 rects.
...
/// `transport_edit_bg.png` — 11x11, 0 rects.
...
/// `transport_end.png` — 108x26, 179 rects.
...
/// `transport_group_bg.png` — 11x11, 0 rects.
...
/// `transport_home.png` — 108x26, 345 rects.
...
/// `transport_knob_bg_large.png` — 32x34, 261 rects.
...
/// `transport_next.png` — 108x26, 215 rects.
...
/// `transport_pause.png` — 108x26, 153 rects.
...
/// `transport_pause_on.png` — 108x26, 1252 rects.
...
/// `transport_play.png` — 108x26, 152 rects.
...
/// `transport_play_on.png` — 108x26, 1276 rects.
...
/// `transport_play_sync.png` — 108x26, 245 rects.
...
/// `transport_play_sync_on.png` — 108x26, 1287 rects.
...
/// `transport_playspeedbg.png` — 6x21, 1 rects.
...
/// `transport_playspeedthumb.png` — 22x28, 109 rects.
...
/// `transport_previous.png` — 108x26, 329 rects.
...
/// `transport_record.png` — 108x26, 406 rects.
...
/// `transport_record_item.png` — 108x26, 544 rects.
...
/// `transport_record_item_on.png` — 108x26, 1772 rects.
...
/// `transport_record_loop.png` — 108x26, 538 rects.
...
/// `transport_record_loop_on.png` — 108x26, 1630 rects.
...
/// `transport_record_on.png` — 108x26, 1611 rects.
...
/// `transport_repeat_off.png` — 96x24, 457 rects.
...
/// `transport_repeat_on.png` — 96x24, 459 rects.
...
/// `transport_status_bg.png` — 32x28, 68 rects.
...
/// `transport_status_bg_err.png` — 6x10, 1 rects.
...
/// `transport_stop.png` — 108x26, 59 rects.
...
/// `transport_timebase_beat.png` — 99x22, 263 rects.
...
/// `transport_timebase_time.png` — 99x22, 303 rects.
