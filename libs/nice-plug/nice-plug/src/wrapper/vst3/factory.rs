...
//! had to be moved to the `nice_export_vst3!()` macro. Because working in macro-land can be both
...
fn make_subcategories_string<P: Vst3Plugin>() -> String {
    ...
    crate::nice_debug_assert!(!P::VST3_SUBCATEGORIES.contains(&Vst3SubCategory::Custom("OnlyRT")));
    ...
    crate::nice_debug_assert!(subcategory_string.len() <= 127);
